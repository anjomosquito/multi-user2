                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('admin.announcements.index')" :active="route().current('admin.announcements.index')">
                                    <svg version="1.1" width="45px" height="100px" class="icon" viewBox="0 0 1024 1024" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve">
                                    <g>
